...
const FullHomePaintingCard = ({ item, idx }) => {
    ...
    return (
        ...
        <div key={idx} className='px-8 py-4 '>
            <h1 className="text-[2rem] md:text-[2rem] font-medium text-black capitalize text-center relative inline-block leading-12">
                {title}
            </h1>

            {
                types?.map((type, idx) => {
                    return (
                        <div key={idx} className='h-[200px] flex gap-2 border-b-[0.1px] border-gray-400 pt-4  '>
                            ...
                            <div className='w-[35%] flex items-start justify-center px-4'>
                                <img
                                    src={type?.image} alt=""
                                    className='h-[150px] w-[150px] rounded-md object-center object-cover'
                                />
                            </div>
                        </div>
                    )
