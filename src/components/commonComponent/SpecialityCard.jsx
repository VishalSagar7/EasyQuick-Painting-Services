...
const SpecialityCard = ({ speciality }) => {
  ...
  return (
      <div data-aos="fade-right" className='md:h-[350px] md:w-[400px] px-8 py-4  md:p-6 bg-[#8a0136] rounded-lg transition-transform duration-100 hover:bg-[#8a0135f1] text-white shadow-md flex flex-col items-center gap-2 md:gap-4'>
          {speciality?.logo }
